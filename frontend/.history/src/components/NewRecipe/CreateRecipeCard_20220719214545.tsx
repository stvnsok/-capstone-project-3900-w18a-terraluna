            ...
            <form>
                ...
                <div>
                    ...
                    <input 
                        ...
                        className = 'shadow appearance-none border rounded w-full box-border h-32 w-32 p-4 border-4 text-gray-700 leading-tight focus:outline-none focus:shadow-lg border-opacity-0'
