...
const RecipeCard = ({
    ...
    return <div className=" shadow-md hover:shadow-lg max-w-xs h-[500px] rounded-md bg-tl-inactive-white cursor-pointer" style={{
        ...
        onClick={onClick}
    >
    <img src={recipe.imageUrl ? `http://localhost:5000/uploads?name=${recipe.imageUrl}` : 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/1024px-No_image_available.svg.png'} className="p-4 border-b border-solid" alt="recipe" style={{
        width: '100%',
        height: '50%',
