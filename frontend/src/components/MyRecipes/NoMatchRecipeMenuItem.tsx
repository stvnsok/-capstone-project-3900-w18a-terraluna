...
const NoMatchRecipeMenuItem = ({
    ...
    return  <React.Fragment>
            ...
            >
                ...
                {showIngredients && <div className='absolute rounded-md p-2 w-auto bg-tl-inactive-white border border-solid border-tl-inactive-grey left-0 ml-60 top-0'>
                    {noMatchIngredients.ingredients.map(ingredient => <div>
                        {ingredient.name}
                    </div>)}    
                </div>}
            </div>
